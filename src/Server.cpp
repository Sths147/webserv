...
const	std::string									&Server::get_inlocation_cgi_path( void )				const { return (this->_ConfServer.get_inlocation_cgi_path()); }
const	std::string									&Server::get_inlocation_cgi_extension( void )			const { return (this->_ConfServer.get_inlocation_cgi_extension()); }
